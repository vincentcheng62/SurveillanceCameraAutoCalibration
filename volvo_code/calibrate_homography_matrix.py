...
cross_subpixel_undistorted_matrix = cv2.undistortPoints(cross_subpixel_matrix.reshape(-1,1,2).astype(np.float64), camera_matrix_manual, dist_coefs_manual)
...
H, mask = cv2.findHomography(cross_subpixel_undistorted_matrix, gps_matrix, cv2.RANSAC, ransacReprojThreshold)
print(" ")
print("[OUTPUT]")
