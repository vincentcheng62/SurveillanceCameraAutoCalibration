...
print("live_camera_img_path: ", live_camera_img_path)
print("orthomosaic_img_path: ", orthomosaic_img_path)
print("orthomosaic_geotiff_path: ", orthomosaic_geotiff_path)
...
print("scaledown factor for orthomosaic: ", scaledown)
#resized_img1 = cv.resize(img1, (0,0), fx=(1/scaledown), fy=(1/scaledown)) 
resized_img1 = img1.copy()
resized_img2 = cv.resize(img2, (0,0), fx=(1/scaledown), fy=(1/scaledown)) 
...
print("Start to knn brute force matching...")
matches = bf.knnMatch(des1,des2,k=knnnum)
...
if len(good_matches) > 3:
    ...
    print("len(maskin) of homography: ", maskin)
    print("fittingerror in pixel of the projected points: ", totalfittingerror/maskin)
...
print("All results are logged in: ", output_dir)
print('Whole process took seconds: ',time.time() - start)