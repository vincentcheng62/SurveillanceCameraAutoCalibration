...
def test_general_hough(gh, reference_image, query):
    ...
    print("max voting is: ", accumulator.argmax())
...
def test():
    ...
    reference_image = imread("../images/maskout.bmp", flatten=True)
    detect_s = general_hough_closure(reference_image)
    test_general_hough(detect_s, reference_image, "../images/maskout2.bmp")
